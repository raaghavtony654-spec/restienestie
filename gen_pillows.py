...
products_html = '<section class="page-header"><h1 style="text-align:center; font-family:var(--font-serif); font-size:3rem; font-weight:300; margin:10rem 0 4rem 0; color:#4B3621;">Our Pillow Collection</h1></section>'
sort_ui = """
